...
export type Mapping = {
  ...
  udpDropPerIP?: number;
  udpDropRate?: number;
  udpIngressPackets?: number;
  udpIngressBytes?: number;
  udpToNodePackets?: number;
  udpToNodeBytes?: number;
  udpFromNodePackets?: number;
  udpFromNodeBytes?: number;
  udpToClientPackets?: number;
  udpToClientBytes?: number;
  udpDropAcl?: number;
  udpDropSpa?: number;
  udpDropTrafficLimit?: number;
  udpDropNoPath?: number;
  udpDropEncode?: number;
  udpDropUplaneWrite?: number;
  udpDropTunnelWrite?: number;
  udpDropUnknownFlow?: number;
  udpDropClientWrite?: number;
